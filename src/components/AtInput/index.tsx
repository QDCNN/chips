...
export default class AtInput extends React.Component<AtInputProps> {
  ...
  public render(): JSX.Element {
    ...
    const errorIconCls = classNames({ // 错误按钮
      "at-input__overlay--hidden": !error,
    })
    const clearIconCls = classNames({ // 清除按钮
      "at-input__overlay--hidden": !(clear && value),
    })
    ...
    return (
      <View className={rootCls} style={customStyle}>
        <View className={containerCls}>
          ...
          <View className={classNames('at-input__icon', clearIconCls)} onTouchEnd={this.handleClearValue}>
            <Image src={clearIcon} className='at-icon at-icon_image at-icon-close-circle at-input__icon-close'></Image>
          </View>
          {/* {error && (
            <View
          ...
          <View
            className={classNames('at-input__icon', errorIconCls)}
            onTouchStart={this.handleErrorClick}
          >
            <Image src={errorIcon} className='"at-icon at-icon_image at-icon-alert-circle at-input__icon-alert"'></Image>
          </View>
