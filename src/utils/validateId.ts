...
// //         // 分析      0-9 6次     年份 18xx   0-9 2次   月份 01 10月以后   日期 01-29 30 31  0-9 3次   0-9 X x
...
// //             pass = false;
// //         //校验长度，类型
// //         if (pass && validateIdCard.IdentityCode_isCardNo(card) === false)
// //             pass = false;
// //         return pass
// //     }
// // }
// // export default validateIdCard.IdentityCodeValid   //导出
...
export const validateIdCard = (idcard) => {
  ...
  if (len === 15) {
    var re_fifteen = /^(\d{6})(\d{2})(\d{2})(\d{2})(\d{3})$/;
    flag = re_fifteen.test(idcard)
  }
  if (len === 18) {
    var re_eighteen = /^(\d{6})(\d{4})(\d{2})(\d{2})(\d{3})([0-9]|X|x)$/;
    flag = re_eighteen.test(idcard)
  }
  return flag
...
export const validateMobile = (mobile) => {
  let flag = false;
  var re_mobile = /^1[3456789]{1}\d{9}$/;
  flag = re_mobile.test(mobile)
  return flag
}